...
# There are three TF-IDF variants that can be used for different  and document sizes.
```{r}
...
# Comparison
# Variant 1 
# The function used is identical to the orginal function, this means that the results are identical.
# Variant 2
